...
int
lisy_set_gamename(char* arg_from_main, char* lisy_gamename) {
    int res;
...
int
lisy_time_to_quit(void) {
    return lisy_time_to_quit_flag;
}

//sound handler
void
lisy_sound_handler(unsigned char board, unsigned char data) {
